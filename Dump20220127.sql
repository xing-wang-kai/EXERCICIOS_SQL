...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-01-07 02:59:10',NULL),('diagnostics.include_raw','OFF','2022-01-07 02:59:10',NULL),('ps_thread_trx_info.max_length','65535','2022-01-07 02:59:10',NULL),('statement_performance_analyzer.limit','100','2022-01-07 02:59:10',NULL),('statement_performance_analyzer.view',NULL,'2022-01-07 02:59:10',NULL),('statement_truncate_len','64','2022-01-07 02:59:10',NULL);
...
-- Dump completed on 2022-01-27 14:27:00
...
INSERT INTO `cursos` VALUES (1,'html5','gustavo guanabara','curso de html',40,37,2014),(2,'algoritimos','gustavo guanabara','lógica de algoritimos',20,15,2014),(3,'photoshop','gustavo guanabara','introdução ao photoshop',10,8,2014),(4,'php','gustavo guanabara','curso de PHP para iniciantes',40,20,2010),(5,'java','gustavo guanabara','introducao a linguagem java',40,29,2000),(6,'mySql','gustavo guanabara','banco de dados MySQL',30,15,2016),(7,'word','gustavo guanabara','curso completo de word',40,30,2016),(8,'sapateado','gustavo guanabara','dança ritmicas',40,30,2018),(9,'cozinha arabe','gustavo guanabara','aprenda a fazer Kibs',40,30,2018),(10,'youTube','gustavo guanabara','Gerar polemicas e ganhar inscritos',5,2,2018);
...
CREATE TABLE `pessoas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(30) NOT NULL,
  `prof` varchar(20) NOT NULL DEFAULT 'autonomo',
  `nascimente` date DEFAULT NULL,
  `sexo` enum('F','M') DEFAULT NULL,
  `peso` decimal(5,2) DEFAULT NULL,
  `altura` decimal(3,2) DEFAULT NULL,
  `nascionalidade` varchar(20) NOT NULL DEFAULT 'Brasil',
  PRIMARY KEY (`id`)
...
INSERT INTO `pessoas` VALUES (1,'godofredo','autonomo','1990-12-01','M',68.89,1.23,'argentino'),(2,'Maria','autonomo','1998-12-01','F',58.89,1.69,'Portugal'),(3,'Thiago','autonomo','2001-12-01','M',61.00,1.80,'Lisboa'),(4,'Helena','autonomo','1998-02-03','F',57.80,1.50,'França'),(5,'Georgio','autonomo','1987-04-01','M',78.80,1.80,'Britsh');
